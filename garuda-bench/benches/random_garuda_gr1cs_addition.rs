...
const FIXED_R1CS_CONSTRAINTS: usize = 2usize.pow(15);
const FIXED_DEG5_CONSTRAINTS: usize = 2usize.pow(15);
    ...
    <E::G1Affine as AffineRepr>::BaseField: PrimeField,
{
    ...
    let circuit = RandomCircuit::<E::ScalarField>::new(
    ...
    BenchResult {
        ...
        num_invocations: FIXED_R1CS_CONSTRAINTS + FIXED_DEG5_CONSTRAINTS,
...
fn main() {
    ...
    let configs: Vec<usize> = NONZERO_MULTIPLIERS.to_vec();
    for &nonzero_per_constraint in configs.iter() {
        let filename = format!("random-garuda-gr1cs-addition{}-{}t.csv", zk_string, 1);
