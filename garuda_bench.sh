...
commands=(
  ...
  "RAYON_NUM_THREADS=1 cargo bench --bench rescue-garuda --features \"gr1cs\""
  "RAYON_NUM_THREADS=1 cargo bench --bench rescue-garuda --features \"r1cs\""
  ...
  "RAYON_NUM_THREADS=1 cargo bench --bench rescue-spartan-nizk --features \"gr1cs\""
  "RAYON_NUM_THREADS=1 cargo bench --bench rescue-spartan-nizk--features \"r1cs\""
