...
contract Pari {
    ...
    uint256 constant COSET_OFFSET_TO_COSET_SIZE_INVERSE =
        11347194993091718065046243966023418845395298417436403564330549161691187507473;
            ...
            addmod(
                addmod(
                    addmod(
                        addmod(
                            ...
                            addmod(
                                mulmod(lagrange_2, input[2], R),
                                mulmod(lagrange_3, input[3], R),
                                R
                            ),
                            R
                        ),
                        addmod(
                            addmod(
                                mulmod(lagrange_4, input[4], R),
                                mulmod(lagrange_5, input[5], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_6, input[6], R),
                                mulmod(lagrange_7, input[7], R),
                                R
                            ),
                            R
                        ),
                    ...
                    addmod(
                        addmod(
                            addmod(
                                mulmod(lagrange_8, input[8], R),
                                mulmod(lagrange_9, input[9], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_10, input[10], R),
                                mulmod(lagrange_11, input[11], R),
                                R
                            ),
                            R
                        ),
                        addmod(
                            addmod(
                                mulmod(lagrange_12, input[12], R),
                                mulmod(lagrange_13, input[13], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_14, input[14], R),
                                mulmod(lagrange_15, input[15], R),
                                R
                            ),
                            R
                        ),
                ...
                addmod(
                    addmod(
                        addmod(
                            addmod(
                                mulmod(lagrange_16, input[16], R),
                                mulmod(lagrange_17, input[17], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_18, input[18], R),
                                mulmod(lagrange_19, input[19], R),
                                R
                            ),
                            R
                        ),
                        addmod(
                            addmod(
                                mulmod(lagrange_20, input[20], R),
                                mulmod(lagrange_21, input[21], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_22, input[22], R),
                                mulmod(lagrange_23, input[23], R),
                                R
                            ),
                            R
                        ),
                    ...
                    addmod(
                        addmod(
                            addmod(
                                mulmod(lagrange_24, input[24], R),
                                mulmod(lagrange_25, input[25], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_26, input[26], R),
                                mulmod(lagrange_27, input[27], R),
                                R
                            ),
                            R
                        ),
                        addmod(
                            addmod(
                                mulmod(lagrange_28, input[28], R),
                                mulmod(lagrange_29, input[29], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_30, input[30], R),
                                mulmod(lagrange_31, input[31], R),
                                R
                            ),
                            R
                        ),
            ...
            addmod(
                addmod(
                    addmod(
                        addmod(
                            addmod(
                                mulmod(lagrange_32, input[32], R),
                                mulmod(lagrange_33, input[33], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_34, input[34], R),
                                mulmod(lagrange_35, input[35], R),
                                R
                            ),
                            R
                        ),
                        addmod(
                            addmod(
                                mulmod(lagrange_36, input[36], R),
                                mulmod(lagrange_37, input[37], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_38, input[38], R),
                                mulmod(lagrange_39, input[39], R),
                                R
                            ),
                            R
                        ),
                    ...
                    addmod(
                        addmod(
                            addmod(
                                mulmod(lagrange_40, input[40], R),
                                mulmod(lagrange_41, input[41], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_42, input[42], R),
                                mulmod(lagrange_43, input[43], R),
                                R
                            ),
                            R
                        ),
                        addmod(
                            addmod(
                                mulmod(lagrange_44, input[44], R),
                                mulmod(lagrange_45, input[45], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_46, input[46], R),
                                mulmod(lagrange_47, input[47], R),
                                R
                            ),
                            R
                        ),
                ...
                addmod(
                    addmod(
                        addmod(
                            addmod(
                                mulmod(lagrange_48, input[48], R),
                                mulmod(lagrange_49, input[49], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_50, input[50], R),
                                mulmod(lagrange_51, input[51], R),
                                R
                            ),
                            R
                        ),
                        addmod(
                            addmod(
                                mulmod(lagrange_52, input[52], R),
                                mulmod(lagrange_53, input[53], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_54, input[54], R),
                                mulmod(lagrange_55, input[55], R),
                                R
                            ),
                            R
                        ),
                    ...
                    addmod(
                        addmod(
                            addmod(
                                mulmod(lagrange_56, input[56], R),
                                mulmod(lagrange_57, input[57], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_58, input[58], R),
                                mulmod(lagrange_59, input[59], R),
                                R
                            ),
                            R
                        ),
                        addmod(
                            addmod(
                                mulmod(lagrange_60, input[60], R),
                                mulmod(lagrange_61, input[61], R),
                                R
                            ),
                            addmod(
                                mulmod(lagrange_62, input[62], R),
                                mulmod(lagrange_63, input[63], R),
                                R
                            ),
                            R
                        ),
