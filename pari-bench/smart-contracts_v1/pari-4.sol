...
contract Pari {
    ...
    uint256 constant COSET_OFFSET_TO_COSET_SIZE_INVERSE = 18653382959917562167213376162437115795294302501095671230107457692775375197082;

        uint256 constant NEG_H_Gi_0 = 16175997480279746933395696821627914154822356850599360268487194128237653231431;
    uint256 constant NEG_H_Gi_1 = 13488569025524737867302864233609557659477632275399951256322143898195466665559;
    uint256 constant NEG_H_Gi_2 = 4291719281990414555583180210772021930674129156919794513029309435717198722503;
    uint256 constant NEG_H_Gi_3 = 10760960843605029931168477152256059251122553010073327248776518267816012820457;

        uint256 constant NOM_0 = 15539842382669954142031268400134241142337170745446360923914944934105925904176;
    uint256 constant NOM_1 = 10222995356505903940975188694604582723849522771475029037154255003478388982150;
    uint256 constant NOM_2 = 2468451619329716913459422793229595129991275015765428543510103495098681838763;
    uint256 constant NOM_3 = 15450255519554846137616362502474324568186573450625084380423717062079961668941;
...
uint256 x_a = addmod(addmod(mulmod(lagrange_0, input[0], R), mulmod(lagrange_1, input[1], R), R), addmod(mulmod(lagrange_2, input[2], R), mulmod(lagrange_3, input[3], R), R), R);
