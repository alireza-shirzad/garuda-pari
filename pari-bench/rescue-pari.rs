...
fn main() {
    ...
    pari_bench!(pari_bench, 72, 1, num_thread, Bls12_381, BlsFr12_381_Fr).save_to_csv(false);
    pari_bench!(pari_bench, 144, 5, num_thread, Bls12_381, BlsFr12_381_Fr).save_to_csv(true);
    pari_bench!(pari_bench, 288, 5, num_thread, Bls12_381, BlsFr12_381_Fr).save_to_csv(true);
    pari_bench!(pari_bench, 577, 5, num_thread, Bls12_381, BlsFr12_381_Fr).save_to_csv(true);
    pari_bench!(pari_bench, 1154, 1, num_thread, Bls12_381, BlsFr12_381_Fr).save_to_csv(true);
    pari_bench!(pari_bench, 2309, 1, num_thread, Bls12_381, BlsFr12_381_Fr).save_to_csv(true);
    pari_bench!(pari_bench, 4619, 1, num_thread, Bls12_381, BlsFr12_381_Fr).save_to_csv(true);
    pari_bench!(pari_bench, 9238, 1, num_thread, Bls12_381, BlsFr12_381_Fr).save_to_csv(true);
    // pari_bench!(
    //     pari_bench,
    //     18477,
    //     1,
