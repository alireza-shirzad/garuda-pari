...
contract Pari {
    ...
    uint256 constant COSET_OFFSET_TO_COSET_SIZE_INVERSE = 8405086447822313838752646273194456000031217045728360237704343779480766987115;

        uint256 constant NEG_H_Gi_0 = 13326885000311358912287078648031726819564990472170503574014291661505430978205;
    uint256 constant NEG_H_Gi_1 = 4849392470595825263046812474188855353535321188723106867993138455938662753942;

        uint256 constant NOM_0 = 14220450601458511673532606231352176427117945320416516159190713724478490024550;
    uint256 constant NOM_1 = 5548614325997279117816616015086394390005228669711183081159836678771404380761;
...
uint256 x_a = addmod(mulmod(lagrange_0, input[0], R), mulmod(lagrange_1, input[1], R), R);
