...
// Pari verifier for input size 4
contract Pari {
    ...
    uint256 constant COSET_SIZE = 262144;
    ...
    uint256 constant COSET_OFFSET_TO_COSET_SIZE_INVERSE = 1113077753200850486461876738074599368190231286005330254581801667052180153927;

        uint256 constant NEG_H_Gi_0 = 9460311821707834715711181138043132589133068654866620231714460018333870198688;
    uint256 constant NEG_H_Gi_1 = 9115286727055935177327888358310580472445019386533391973839103395614537191414;
    uint256 constant NEG_H_Gi_2 = 11007530221734506576895293781103806543141125147465671720867183085897460440812;
    uint256 constant NEG_H_Gi_3 = 13791798063019828776826295234829089693025428835480412733599680777867578903597;

        uint256 constant NOM_0 = 8668979155487429191023186167244286802369585077499776418781004084441063504559;
    uint256 constant NOM_1 = 13841618990167222845337856898199596452833433888090553583913619750328693560873;
    uint256 constant NOM_2 = 3733180525252791983087841930051907884727352623249005635433890130658155924681;
    uint256 constant NOM_3 = 12026935108225291368502515129914128370135746379823841716112002989773258125777;
...
uint256 x_a = addmod(addmod(addmod(mulmod(lagrange_0, input[0], R), mulmod(lagrange_1, input[1], R), R), mulmod(lagrange_2, input[2], R), R), mulmod(lagrange_3, input[3], R), R);
